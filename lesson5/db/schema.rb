...
ActiveRecord::Schema.define(version: 2022_01_04_114940) do
  ...
  create_table "diagnosis_items", force: :cascade do |t|
    t.text "content", default: "Healthy", null: false
    t.bigint "physician_id"
    t.bigint "patient_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "patients", force: :cascade do |t|
    ...
    t.string "email", default: "email@gmail.com", null: false
  end
  ...
  create_table "physicians", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.string "last_name", default: "Last Name", null: false
    t.string "phone_number", default: "+380987654321", null: false
